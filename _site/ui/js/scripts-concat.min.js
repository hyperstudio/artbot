...
if(null==a&&(a=[]),n&&a.reduce===n)return d&&(b=x.bind(b,d)),e?a.reduce(b,c):a.reduce(b);if(y(a,function(a,f,g){e?c=b.call(d,c,a,f,g):(c=a,e=!0)}),!e)throw new TypeError(z);return c},x.reduceRight=x.foldr=function(a,b,c,d){var e=arguments.length>2;if(null==a&&(a=[]),o&&a.reduceRight===o)return d&&(b=x.bind(b,d)),e?a.reduceRight(b,c):a.reduceRight(b);var f=a.length;if(f!==+f){var g=x.keys(a);f=g.length}if(y(a,function(h,i,j){i=g?g[--f]:--f,e?c=b.call(d,c,a[i],i,j):(c=a[i],e=!0)}),!e)throw new TypeError(z);return c},x.find=x.detect=function(a,b,c){var d;return A(a,function(a,e,f){return b.call(c,a,e,f)?(d=a,!0):void 0}),d},x.filter=x.select=function(a,b,c){var d=[];return null==a?d:p&&a.filter===p?a.filter(b,c):(y(a,function(a,e,f){b.call(c,a,e,f)&&d.push(a)}),d)},x.reject=function(a,b,c){return x.filter(a,function(a,d,e){return!b.call(c,a,d,e)},c)},x.every=x.all=function(a,b,d){b||(b=x.identity);var e=!0;return null==a?e:q&&a.every===q?a.every(b,d):(y(a,function(a,f,g){return(e=e&&b.call(d,a,f,g))?void 0:c}),!!e)};var A=x.some=x.any=function(a,b,d){b||(b=x.identity);var e=!1;return null==a?e:r&&a.some===r?a.some(b,d):(y(a,function(a,f,g){return e||(e=b.call(d,a,f,g))?c:void 0}),!!e)};x.contains=x.include=function(a,b){return null==a?!1:s&&a.indexOf===s?-1!=a.indexOf(b):A(a,function(a){return a===b})},x.invoke=function(a,b){var c=h.call(arguments,2),d=x.isFunction(b);return x.map(a,function(a){return(d?b:a[b]).apply(a,c)})},x.pluck=function(a,b){return x.map(a,x.property(b))},x.where=function(a,b){return x.filter(a,x.matches(b))},x.findWhere=function(a,b){return x.find(a,x.matches(b))},x.max=function(a,b,c){if(!b&&x.isArray(a)&&a[0]===+a[0]&&a.length<65535)return Math.max.apply(Math,a);var d=-1/0,e=-1/0;return y(a,function(a,f,g){var h=b?b.call(c,a,f,g):a;h>e&&(d=a,e=h)}),d},x.min=function(a,b,c){if(!b&&x.isArray(a)&&a[0]===+a[0]&&a.length<65535)return Math.min.apply(Math,a);var d=1/0,e=1/0;return y(a,function(a,f,g){var h=b?b.call(c,a,f,g):a;e>h&&(d=a,e=h)}),d},x.shuffle=function(a){var b,c=0,d=[];return y(a,function(a){b=x.random(c++),d[c-1]=d[b],d[b]=a}),d},x.sample=function(a,b,c){return null==b||c?(a.length!==+a.length&&(a=x.values(a)),a[x.random(a.length-1)]):x.shuffle(a).slice(0,Math.max(0,b))};var B=function(a){return null==a?x.identity:x.isFunction(a)?a:x.property(a)};x.sortBy=function(a,b,c){return b=B(b),x.pluck(x.map(a,function(a,d,e){return{value:a,index:d,criteria:b.call(c,a,d,e)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==d){if(c>d||void 0===c)return 1;if(d>c||void 0===d)return-1}return a.index-b.index}),"value")};var C=function(a){return function(b,c,d){var e={};return c=B(c),y(b,function(f,g){var h=c.call(d,f,g,b);a(e,h,f)}),e}};x.groupBy=C(function(a,b,c){x.has(a,b)?a[b].push(c):a[b]=[c]}),x.indexBy=C(function(a,b,c){a[b]=c}),x.countBy=C(function(a,b){x.has(a,b)?a[b]++:a[b]=1}),x.sortedIndex=function(a,b,c,d){c=B(c);for(var e=c.call(d,b),f=0,g=a.length;g>f;){var h=f+g>>>1;c.call(d,a[h])<e?f=h+1:g=h}return f},x.toArray=function(a){return a?x.isArray(a)?h.call(a):a.length===+a.length?x.map(a,x.identity):x.values(a):[]},x.size=function(a){return null==a?0:a.length===+a.length?a.length:x.keys(a).length},x.first=x.head=x.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:0>b?[]:h.call(a,0,b)},x.initial=function(a,b,c){return h.call(a,0,a.length-(null==b||c?1:b))},x.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:h.call(a,Math.max(a.length-b,0))},x.rest=x.tail=x.drop=function(a,b,c){return h.call(a,null==b||c?1:b)},x.compact=function(a){return x.filter(a,x.identity)};var D=function(a,b,c){return b&&x.every(a,x.isArray)?i.apply(c,a):(y(a,function(a){x.isArray(a)||x.isArguments(a)?b?g.apply(c,a):D(a,b,c):c.push(a)}),c)};x.flatten=function(a,b){return D(a,b,[])},x.without=function(a){return x.difference(a,h.call(arguments,1))},x.partition=function(a,b){var c=[],d=[];return y(a,function(a){(b(a)?c:d).push(a)}),[c,d]},x.uniq=x.unique=function(a,b,c,d){x.isFunction(b)&&(d=c,c=b,b=!1);var e=c?x.map(a,c,d):a,f=[],g=[];return y(e,function(c,d){(b?d&&g[g.length-1]===c:x.contains(g,c))||(g.push(c),f.push(a[d]))}),f},x.union=function(){return x.uniq(x.flatten(arguments,!0))},x.intersection=function(a){var b=h.call(arguments,1);return x.filter(x.uniq(a),function(a){return x.every(b,function(b){return x.contains(b,a)})})},x.difference=function(a){var b=i.apply(d,h.call(arguments,1));return x.filter(a,function(a){return!x.contains(b,a)})},x.zip=function(){for(var a=x.max(x.pluck(arguments,"length").concat(0)),b=new Array(a),c=0;a>c;c++)b[c]=x.pluck(arguments,""+c);return b},x.object=function(a,b){if(null==a)return{};for(var c={},d=0,e=a.length;e>d;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c},x.indexOf=function(a,b,c){if(null==a)return-1;var d=0,e=a.length;if(c){if("number"!=typeof c)return d=x.sortedIndex(a,b),a[d]===b?d:-1;d=0>c?Math.max(0,e+c):c}if(s&&a.indexOf===s)return a.indexOf(b,c);for(;e>d;d++)if(a[d]===b)return d;return-1},x.lastIndexOf=function(a,b,c){if(null==a)return-1;var d=null!=c;if(t&&a.lastIndexOf===t)return d?a.lastIndexOf(b,c):a.lastIndexOf(b);for(var e=d?c:a.length;e--;)if(a[e]===b)return e;return-1},x.range=function(a,b,c){arguments.length<=1&&(b=a||0,a=0),c=arguments[2]||1;for(var d=Math.max(Math.ceil((b-a)/c),0),e=0,f=new Array(d);d>e;)f[e++]=a,a+=c;return f};var E=function(){};x.bind=function(a,b){var c,d;if(w&&a.bind===w)return w.apply(a,h.call(arguments,1));if(!x.isFunction(a))throw new TypeError;return c=h.call(arguments,2),d=function(){if(!(this instanceof d))return a.apply(b,c.concat(h.call(arguments)));E.prototype=a.prototype;var e=new E;E.prototype=null;var f=a.apply(e,c.concat(h.call(arguments)));return Object(f)===f?f:e}},x.partial=function(a){var b=h.call(arguments,1);return function(){for(var c=0,d=b.slice(),e=0,f=d.length;f>e;e++)d[e]===x&&(d[e]=arguments[c++]);for(;c<arguments.length;)d.push(arguments[c++]);return a.apply(this,d)}},x.bindAll=function(a){var b=h.call(arguments,1);if(0===b.length)throw new Error("bindAll must be passed function names");return y(b,function(b){a[b]=x.bind(a[b],a)}),a},x.memoize=function(a,b){var c={};return b||(b=x.identity),function(){var d=b.apply(this,arguments);return x.has(c,d)?c[d]:c[d]=a.apply(this,arguments)}},x.delay=function(a,b){var c=h.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)},x.defer=function(a){return x.delay.apply(x,[a,1].concat(h.call(arguments,1)))},x.throttle=function(a,b,c){var d,e,f,g=null,h=0;c||(c={});var i=function(){h=c.leading===!1?0:x.now(),g=null,f=a.apply(d,e),d=e=null};return function(){var j=x.now();h||c.leading!==!1||(h=j);var k=b-(j-h);return d=this,e=arguments,0>=k?(clearTimeout(g),g=null,h=j,f=a.apply(d,e),d=e=null):g||c.trailing===!1||(g=setTimeout(i,k)),f}},x.debounce=function(a,b,c){var d,e,f,g,h,i=function(){var j=x.now()-g;b>j?d=setTimeout(i,b-j):(d=null,c||(h=a.apply(f,e),f=e=null))};return function(){f=this,e=arguments,g=x.now();var j=c&&!d;return d||(d=setTimeout(i,b)),j&&(h=a.apply(f,e),f=e=null),h}},x.once=function(a){var b,c=!1;return function(){return c?b:(c=!0,b=a.apply(this,arguments),a=null,b)}},x.wrap=function(a,b){return x.partial(b,a)},x.compose=function(){var a=arguments;return function(){for(var b=arguments,c=a.length-1;c>=0;c--)b=[a[c].apply(this,b)];return b[0]}},x.after=function(a,b){return function(){return--a<1?b.apply(this,arguments):void 0}},x.keys=function(a){if(!x.isObject(a))return[];if(v)return v(a);var b=[];for(var c in a)x.has(a,c)&&b.push(c);return b},x.values=function(a){for(var b=x.keys(a),c=b.length,d=new Array(c),e=0;c>e;e++)d[e]=a[b[e]];return d},x.pairs=function(a){for(var b=x.keys(a),c=b.length,d=new Array(c),e=0;c>e;e++)d[e]=[b[e],a[b[e]]];return d},x.invert=function(a){for(var b={},c=x.keys(a),d=0,e=c.length;e>d;d++)b[a[c[d]]]=c[d];return b},x.functions=x.methods=function(a){var b=[];for(var c in a)x.isFunction(a[c])&&b.push(c);return b.sort()},x.extend=function(a){return y(h.call(arguments,1),function(b){if(b)for(var c in b)a[c]=b[c]}),a},x.pick=function(a){var b={},c=i.apply(d,h.call(arguments,1));return y(c,function(c){c in a&&(b[c]=a[c])}),b},x.omit=function(a){var b={},c=i.apply(d,h.call(arguments,1));for(var e in a)x.contains(c,e)||(b[e]=a[e]);return b},x.defaults=function(a){return y(h.call(arguments,1),function(b){if(b)for(var c in b)void 0===a[c]&&(a[c]=b[c])}),a},x.clone=function(a){return x.isObject(a)?x.isArray(a)?a.slice():x.extend({},a):a},x.tap=function(a,b){return b(a),a};var F=function(a,b,c,d){if(a===b)return 0!==a||1/a==1/b;if(null==a||null==b)return a===b;a instanceof x&&(a=a._wrapped),b instanceof x&&(b=b._wrapped);var e=j.call(a);if(e!=j.call(b))return!1;switch(e){case"[object String]":return a==String(b);case"[object Number]":return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case"[object Date]":case"[object Boolean]":return+a==+b;case"[object RegExp]":return a.source==b.source&&a.global==b.global&&a.multiline==b.multiline&&a.ignoreCase==b.ignoreCase}if("object"!=typeof a||"object"!=typeof b)return!1;for(var f=c.length;f--;)if(c[f]==a)return d[f]==b;var g=a.constructor,h=b.constructor;if(g!==h&&!(x.isFunction(g)&&g instanceof g&&x.isFunction(h)&&h instanceof h)&&"constructor"in a&&"constructor"in b)return!1;c.push(a),d.push(b);var i=0,k=!0;if("[object Array]"==e){if(i=a.length,k=i==b.length)for(;i--&&(k=F(a[i],b[i],c,d)););}else{for(var l in a)if(x.has(a,l)&&(i++,!(k=x.has(b,l)&&F(a[l],b[l],c,d))))break;if(k){for(l in b)if(x.has(b,l)&&!i--)break;k=!i}}return c.pop(),d.pop(),k};x.isEqual=function(a,b){return F(a,b,[],[])},x.isEmpty=function(a){if(null==a)return!0;if(x.isArray(a)||x.isString(a))return 0===a.length;for(var b in a)if(x.has(a,b))return!1;return!0},x.isElement=function(a){return!(!a||1!==a.nodeType)},x.isArray=u||function(a){return"[object Array]"==j.call(a)},x.isObject=function(a){return a===Object(a)},y(["Arguments","Function","String","Number","Date","RegExp"],function(a){x["is"+a]=function(b){return j.call(b)=="[object "+a+"]"}}),x.isArguments(arguments)||(x.isArguments=function(a){return!(!a||!x.has(a,"callee"))}),"function"!=typeof/./&&(x.isFunction=function(a){return"function"==typeof a}),x.isFinite=function(a){return isFinite(a)&&!isNaN(parseFloat(a))},x.isNaN=function(a){return x.isNumber(a)&&a!=+a},x.isBoolean=function(a){return a===!0||a===!1||"[object Boolean]"==j.call(a)},x.isNull=function(a){return null===a},x.isUndefined=function(a){return void 0===a},x.has=function(a,b){return k.call(a,b)},x.noConflict=function(){return a._=b,this},x.identity=function(a){return a},x.constant=function(a){return function(){return a}},x.property=function(a){return function(b){return b[a]}},x.matches=function(a){return function(b){if(b===a)return!0;for(var c in a)if(a[c]!==b[c])return!1;return!0}},x.times=function(a,b,c){for(var d=Array(Math.max(0,a)),e=0;a>e;e++)d[e]=b.call(c,e);return d},x.random=function(a,b){return null==b&&(b=a,a=0),a+Math.floor(Math.random()*(b-a+1))},x.now=Date.now||function(){return(new Date).getTime()};var G={escape:{"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;"}};G.unescape=x.invert(G.escape);var H={escape:new RegExp("["+x.keys(G.escape).join("")+"]","g"),unescape:new RegExp("("+x.keys(G.unescape).join("|")+")","g")};x.each(["escape","unescape"],function(a){x[a]=function(b){return null==b?"":(""+b).replace(H[a],function(b){return G[a][b]})}}),x.result=function(a,b){if(null==a)return void 0;var c=a[b];return x.isFunction(c)?c.call(a):c},x.mixin=function(a){y(x.functions(a),function(b){var c=x[b]=a[b];x.prototype[b]=function(){var a=[this._wrapped];return g.apply(a,arguments),M.call(this,c.apply(x,a))}})};var I=0;x.uniqueId=function(a){var b=++I+"";return a?a+b:b},x.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var J=/(.)^/,K={"'":"'","\\":"\\","\r":"r","\n":"n","	":"t","\u2028":"u2028","\u2029":"u2029"},L=/\\|'|\r|\n|\t|\u2028|\u2029/g;x.template=function(a,b,c){var d;c=x.defaults({},c,x.templateSettings);var e=new RegExp([(c.escape||J).source,(c.interpolate||J).source,(c.evaluate||J).source].join("|")+"|$","g"),f=0,g="__p+='";a.replace(e,function(b,c,d,e,h){return g+=a.slice(f,h).replace(L,function(a){return"\\"+K[a]}),c&&(g+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'"),d&&(g+="'+\n((__t=("+d+"))==null?'':__t)+\n'"),e&&(g+="';\n"+e+"\n__p+='"),f=h+b.length,b}),g+="';\n",c.variable||(g="with(obj||{}){\n"+g+"}\n"),g="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+g+"return __p;\n";try{d=new Function(c.variable||"obj","_",g)}catch(h){throw h.source=g,h}if(b)return d(b,x);var i=function(a){return d.call(this,a,x)};return i.source="function("+(c.variable||"obj")+"){\n"+g+"}",i},x.chain=function(a){return x(a).chain()};var M=function(a){return this._chain?x(a).chain():a};x.mixin(x),y(["pop","push","reverse","shift","sort","splice","unshift"],function(a){var b=d[a];x.prototype[a]=function(){var c=this._wrapped;return b.apply(c,arguments),"shift"!=a&&"splice"!=a||0!==c.length||delete c[0],M.call(this,c)}}),y(["concat","join","slice"],function(a){var b=d[a];x.prototype[a]=function(){return M.call(this,b.apply(this._wrapped,arguments))}}),x.extend(x.prototype,{chain:function(){return this._chain=!0,this},value:function(){return this._wrapped}}),"function"==typeof define&&define.amd&&define("underscore",[],function(){return x})}.call(this),Modernizr.addTest("touchcapable",function(){var a;return a="ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?window.screen.width>1279&&1==window.devicePixelRatio||window.screen.width>1e3&&window.innerWidth<.9*window.screen.width?!1:!0:!1}),String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)},jQuery.validator.addMethod("zipcode",function(a,b){return this.optional(b)||/^\d{5}(?:-\d{4})?$/.test(a)},"Please provide a valid zip code."),jQuery.validator.addMethod("remoteEmail",function(){return!0},"User does not exist");var emailRuleSet={required:!0,email:!0},existingEmailRuleSet={required:!0,email:!0,remoteEmail:"remoteEmail"},emailMsgSet={required:"This field is required.",email:"Please enter a valid email address."},passwordMsgSet={required:"This field is required."},confirmPasswordMsgSet={required:"This field is required.",equalTo:"Passwords must match."};jQuery.validator.setDefaults({focusCleanup:!0,focusInvalid:!1,rules:{password_confirmation:{equalTo:"#password"},email:emailRuleSet,zipcode:"zipcode","signin-email":existingEmailRuleSet,"signin-password":"required"},messages:{email:emailMsgSet,password:passwordMsgSet,password_confirmation:confirmPasswordMsgSet,"signin-email":emailMsgSet,"signin-password":passwordMsgSet}});var Artbot=Artbot||{};Artbot.data=Artbot.data||{},Artbot.el={html:$("html"),win:$(window),doc:$(document),body:$("body"),calendarContainer:$("#event-calendar"),eventCalendar:""},Artbot.util={hasTouch:Modernizr.touchcapable,hasPosFixed:Modernizr.positionfixed,hasiOSPosFixed:Modernizr.iospositionfixed,viewportWidth:function(){return Artbot.el.win.width()},viewportHeight:function(){return Artbot.el.win.height()},docHeight:function(){return Artbot.el.doc.height()},bodyHeight:function(){return Artbot.el.body.height()},footerHeight:function(){return Artbot.el.footer.height()},scrollPos:function(){return Artbot.el.win.scrollTop()},mobileMode:function(){return Artbot.util.viewportWidth()<=767?!0:!1},desktopMode:function(){return Artbot.util.viewportWidth()>=1024?!0:!1},orientation:function(){return"undefined"!=typeof orientation?90===Math.abs(window.orientation)?"landscape":"portrait":Artbot.util.viewportWidth()>=Artbot.util.viewportHeight()?"landscape":"portrait"},findQuerystring:function(a){for(url=$("[data-role=page].ui-page-active").attr("data-url"),hu=url.substring(url.indexOf("?")+1),gy=hu.split("&"),i=0;i<gy.length;i++)if(ft=gy[i].split("="),ft[0]==a)return ft[1]},replaceAll:function(a,b,c){return a.replace(new RegExp(b,"g"),c)},isOldIE:function(){return $.browser.msie&&$.browser.version<=8?!0:!1},getNumberOfChildItems:function(a){var b=$(a),c=0;if(b.length>0){var d=b.children();d.length>0&&(c=d.length)}return c},isThereMore:function(a){return jsonArray=a,console.log(jsonArray),jsonArray.length>0?(console.log("There are at least "+jsonArray.length+" results to be fetched"),!0):(console.log("No more results"),!1)},getAuthToken:function(){return authtoken=sessionStorage.authentication_token,"undefined"==typeof authtoken?(authtoken=localStorage.authentication_token,"undefined"!=typeof authtoken&&console.log("Auth token is in localStorage")):console.log("Auth token is in sessionStorage"),authtoken},getCurrentUser:function(){return currentuser=sessionStorage.current_user,"undefined"==typeof currentuser?(currentuser=localStorage.current_user,"undefined"!=typeof currentuser&&console.log("Current user is in localStorage")):console.log("Current user is in sessionStorage"),currentuser}},Artbot.errors={logAjaxError:function(a,b,c,d){console.log("Error: "+c),console.log("jqXHR status: "+a.status+" "+a.statusText),d&&console.log("jqXHR response: "+a.responseText)},showFormError:function(a,b){var c=$.parseJSON(a);console.log("Error JSON: "+JSON.stringify(c));var d,e,f=$("#"+b);f.find("div.error").remove(),$.each(c,function(a,b){d=a.capitalize()+" "+b,console.log("Error text: "+d),e=$("#"+a),e.length>0?($("#"+a+"-error").length>0?($errorLabel=$("#"+a+"-error"),$errorLabel.html(d).show()):($errorLabel=$("<label>").attr("id",a+"-error").addClass("error").html(d).attr("for",a),$errorLabel.insertAfter(e)),e.removeClass("valid").addClass("error").attr("aria-invalid",!0)):$errorDiv=$("<div>").attr("id",a+"-error").addClass("error").html(d).appendTo(f)})}},Artbot.dataService={getJsonFeed:function(a,b){$.getJSON(a,function(a){b(a)})}},Artbot["var"]={itemsPerPage:5,jsonDomain:"http://artbot-api.herokuapp.com",eventDetailID:1,venueDetailID:1,relatedInterests:{}},Artbot.discoverSlider={init:function(){$("#discover-slider").find("ul").length>0&&(console.log("Discover slider initializing"),Artbot.discoverSlider.populateSlider())},populateSlider:function(){var a=function(){},b=Artbot.util.getAuthToken();a="undefined"!=typeof b?function(a){a.setRequestHeader("authentication_token",b),a.setRequestHeader("accept","application/json")}:function(a){a.setRequestHeader("accept","application/json")},$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",data:{per_page:10},url:Artbot["var"].jsonDomain+"/discoveries/",beforeSend:a,success:function(a){Artbot.discoverSlider.buildSlider(a)},error:function(a){console.log("Error fetching Discover slider data"),console.log("jqXHR status: "+a.status+" "+a.statusText),console.log("jqXHR response: "+a.responseText),Artbot.discoverSlider.showErrorMsg("ajax")},complete:function(){$.mobile.loading("hide")}})},buildSlider:function(a){var b=a.events,c=$("#template-discoverslider").html();$("#discover-slider").find("ul").html(_.template(c,{eventArray:b}));var d=$("#discover-slider").find("ul").children().length;console.log("How many pages do we have right now? "+$("div[data-role=page]").length),d>1&&Artbot.discoverSlider.initSlider(),Artbot.favoriteStars.init(),Artbot.footerSlider.init()},initSlider:function(){var a=$("#discover-slider").find("ul").bxSlider({oneToOneTouch:!1,pager:!1,auto:!1,onSliderLoad:function(a){$("#discover-slider").find("ul").find("li").eq(a).addClass("slide-prev"),$("#discover-slider").find("ul").find("li").eq(a+2).addClass("slide-next")},onSlideBefore:function(a,b,c){$(".slide-prev").removeClass("slide-prev"),$(".slide-next").removeClass("slide-next"),$("#discover-slider").find("ul").find("li").eq(c).addClass("slide-prev"),$("#discover-slider").find("ul").find("li").eq(c+2).addClass("slide-next")}});$("#peek-slider-next").click(function(){return a.goToNextSlide(),!1}),$("#peek-slider-previous").click(function(){return a.goToPrevSlide(),!1})},showErrorMsg:function(a){$("#discover-slider").fadeOut(400,function(){$("#discover-slider-msg-"+a).fadeIn(400),$("#discover-slider").show()})}},Artbot.footerSlider={vars:{footSlideInstance:"",footSlideOptions:{minSlides:2,maxSlides:30,slideWidth:140,slideMargin:10,oneToOneTouch:!1,pager:!1,infiniteLoop:!1,nextSelector:"#footer-slider-next",nextText:'<i class="icon icon-fast-forward"></i><span class="visuallyhidden">Next</span>',prevSelector:"#footer-slider-previous",prevText:'<i class="icon icon-rewind"></i><span class="visuallyhidden">Previous</span>',hideControlOnEnd:!0,onSliderLoad:function(){$("#footer-slider-previous").find("a").addClass("btn").addClass("btn-round").attr("title","Previous"),$("#footer-slider-next").find("a").addClass("btn").addClass("btn-round").attr("title","Next")}},pageSize:15,slideTemplate:"",relatedInterestCounter:0,totalRelatedInterests:0,locationRadius:10},init:function(){$("#footer-slider").length>0&&(Artbot.footerSlider.vars.relatedInterestCounter=0,Artbot.footerSlider.vars.slideTemplate=$("#favorites-slider").length>0?$("#template-favoriteslider").html():$("#template-eventslider").html(),Artbot.footerSlider.populateSlider())},populateSlider:function(){if($("#favorites-slider").length>0){var a=Artbot.util.getAuthToken();"undefined"!=typeof a?$.ajax({type:"GET",dataType:"json",data:{per_page:Artbot.footerSlider.vars.pageSize},url:Artbot["var"].jsonDomain+"/favorites/",beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){var b=JSON.stringify(a.favorites);$(".footer-slider-msg").hide(),b.length>2?(Artbot.footerSlider.buildSlider(a),Artbot.footerSlider.initSlider()):Artbot.footerSlider.showErrorMsg("nofavorites")},error:function(a){console.log("Error fetching footer slider data"),console.log("jqXHR status: "+a.status+" "+a.statusText),console.log("jqXHR response: "+a.responseText)}}):Artbot.footerSlider.showErrorMsg("favoritesignup")}else if($("#venue-events-slider").length>0){var b=Artbot["var"].venueDetailID;$.ajax({type:"GET",dataType:"json",data:{per_page:Artbot.footerSlider.vars.pageSize},url:Artbot["var"].jsonDomain+"/locations/"+b+"/events",beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){var b=JSON.stringify(a.events);$(".footer-slider-msg").hide(),b.length>2?(Artbot.footerSlider.buildSlider(a),Artbot.footerSlider.initSlider()):Artbot.footerSlider.showErrorMsg("noevents")},error:function(a){console.log("Error fetching footer slider data"),console.log("jqXHR status: "+a.status+" "+a.statusText),console.log("jqXHR response: "+a.responseText)}})}else if($("#related-interest-slider").length>0){var c=JSON.stringify(Artbot["var"].relatedInterests);if(c.length>2){var d=0;$.each(Artbot["var"].relatedInterests,function(){d++}),Artbot.footerSlider.vars.totalRelatedInterests=d-1,d>1?$("#cycle-relatedinterest").click(function(){return Artbot.footerSlider.cycleRelatedInterests(Artbot["var"].relatedInterests),!1}).addClass("is-visible"):$("#cycle-relatedinterest").removeClass("is-visible"),Artbot.footerSlider.cycleRelatedInterests(Artbot["var"].relatedInterests)}else Artbot.footerSlider.showErrorMsg("noevents")}else $("#near-you-slider").length>0&&Artbot.geolocation.getLocation(Artbot.footerSlider.processNearbyEvents,Artbot.footerSlider.showGeolocationError)},processNearbyEvents:function(){""!==Artbot.geolocation.vars.currentLatitude&&""!==Artbot.geolocation.vars.currentLongitude?$.ajax({type:"GET",dataType:"json",url:Artbot["var"].jsonDomain+"/events",data:{latitude:Artbot.geolocation.vars.currentLatitude,longitude:Artbot.geolocation.vars.currentLongitude,radius:Artbot.footerSlider.vars.locationRadius,per_page:Artbot.footerSlider.vars.pageSize},beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){var b=JSON.stringify(a.events);$(".footer-slider-msg").hide(),b.length>2?(Artbot.footerSlider.buildSlider(a),Artbot.footerSlider.initSlider()):($("#location-radius").html(Artbot.footerSlider.vars.locationRadius),Artbot.footerSlider.showErrorMsg("noeventsnearby"))},error:function(a){console.log("Error fetching footer slider data"),console.log("jqXHR status: "+a.status+" "+a.statusText),console.log("jqXHR response: "+a.responseText)},complete:function(){$.mobile.loading("hide")}}):(Artbot.footerSlider.showErrorMsg("nogeolocation"),$.mobile.loading("hide"))},hideFooter:function(){$(".content.layout-footer").removeClass("layout-footer"),$(".footer").hide()},cycleRelatedInterests:function(a){var b=a[Artbot.footerSlider.vars.relatedInterestCounter];$.mobile.loading("show"),$("#footer-slider").empty(),$("#target-relatedinterest").text(b.tag.name),$(".footer-slider-msg").hide();var c=b.events;Artbot.footerSlider.buildSlider(c),""===Artbot.footerSlider.vars.footSlideInstance?Artbot.footerSlider.initSlider():Artbot.footerSlider.reload(),$.mobile.loading("hide"),Artbot.footerSlider.vars.relatedInterestCounter<Artbot.footerSlider.vars.totalRelatedInterests?Artbot.footerSlider.vars.relatedInterestCounter++:Artbot.footerSlider.vars.relatedInterestCounter=0},buildSlider:function(a){var b;b=$("#favorites-slider").length>0?a.favorites:$("#related-interest-slider").length>0?a:a.events,$("#footer-slider").html(_.template(Artbot.footerSlider.vars.slideTemplate,{itemArray:b}))},initSlider:function(){Artbot.footerSlider.vars.footSlideInstance=$("#footer-slider").bxSlider(Artbot.footerSlider.vars.footSlideOptions)},initSliderNav:function(){$(".footer-slider").removeClass("not-enough-slides");var a=$("#footer-slider").children("li:not(.bx-clone)").length;$("#footer-slider-next").unbind("click"),$("#footer-slider-previous").unbind("click"),a>2?($("#footer-slider-next").click(function(){return Artbot.footerSlider.vars.footSlideInstance.goToNextSlide(),!1}),$("#footer-slider-previous").click(function(){return Artbot.footerSlider.vars.footSlideInstance.goToPrevSlide(),!1})):$(".footer-slider").addClass("not-enough-slides")},addFavorite:function(a){if(""===Artbot.footerSlider.vars.footSlideInstance)$(".footer-slider-msg").hide(),Artbot.footerSlider.init();else{var b=a,c=_.template(Artbot.footerSlider.vars.slideTemplate,{itemArray:b});$(c).prependTo($("#footer-slider")),Artbot.footerSlider.reload()}},removeFavorite:function(a){$("#footer-slider").find("a[href='event.html?eventid="+a+"']").parent("li").remove();var b=$("#footer-slider").children("li:not(.bx-clone)").length;b>0?Artbot.footerSlider.reload():Artbot.footerSlider.showErrorMsg("nofavorites")},reload:function(){$("#footer-slider").length>0&&""!==Artbot.footerSlider.vars.footSlideInstance&&(Artbot.footerSlider.vars.footSlideInstance.reloadSlider(Artbot.footerSlider.vars.footSlideOptions),Artbot.footerSlider.initSliderNav())},showErrorMsg:function(a){$("#footer-slider").fadeOut(400,function(){$("#footer-slider-msg-"+a).fadeIn(400),$("#footer-slider").show()})},showGeolocationError:function(){Artbot.footerSlider.showErrorMsg("nogeolocation")},destroy:function(){$("#footer-slider").length>0&&""!==Artbot.footerSlider.vars.footSlideInstance&&$("#footer-slider").fadeOut(400,function(){Artbot.footerSlider.vars.footSlideInstance.destroySlider(),Artbot.footerSlider.vars.footSlideInstance="",$("#footer-slider").empty(),$("#footer-slider").fadeIn(400)})}},Artbot.favoriteStars={init:function(){$(".favorite-star").length>0&&(Artbot.favoriteStars.destroy(),Artbot.favoriteStars.sync(),$(".favorite-star").click(function(){var a=Artbot.util.getAuthToken();if("undefined"!=typeof a){var b=$(this).data("event-id"),c=$(this),d=$(this).find(".icon");if(d.hasClass("icon-star"))$.mobile.loading("show"),$.ajax({type:"POST",url:Artbot["var"].jsonDomain+"/events/"+b+"/favorite/",beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){var b=a.favorite.id;Artbot.favoriteStars.highlightStar(c,b),$("#favorites-slider").length>0&&Artbot.footerSlider.addFavorite(a)},error:function(a,b,c){console.log("Error saving favorite"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide"),c.blur()}});else{$.mobile.loading("show");var e=$(this).attr("data-user-favorite-id");$.ajax({type:"POST",url:Artbot["var"].jsonDomain+"/favorites/"+e,data:{_method:"delete"},beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(){Artbot.favoriteStars.unhighlightStar(c),$("#favorites-slider").length>0&&Artbot.footerSlider.removeFavorite(b)},error:function(a,b,c){console.log("Error deleting favorite"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide"),c.blur()}})}}else Artbot.signupModal.open();return!1}))},destroy:function(){$(".favorite-star").length>0&&$(".favorite-star").unbind("click")},sync:function(){var a=Artbot.util.getAuthToken();$(".favorite-star").length>0&&"undefined"!=typeof a&&$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/favorites/",data:{page:1,per_page:1e4},beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(b){var c=b.favorites;$.each(c,function(a){var b=c[a],d=b.id;if(-1!=d){var e=b.event.id;$(".favorite-star").each(function(){var a=$(this).attr("data-event-id");a==e&&Artbot.favoriteStars.highlightStar($(this),d)})}}),$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/favorites/history/",data:{page:1,per_page:1e4},beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){var b=a.favorites;$.each(b,function(a){var c=b[a],d=c.id;if(-1!=d){var e=c.event.id;$(".favorite-star").each(function(){var a=$(this).attr("data-event-id");a==e&&Artbot.favoriteStars.highlightStar($(this),d)})}})},error:function(a,b,c){console.log("Error fetching History data to sync stars"),Artbot.errors.logAjaxError(a,b,c)}})},error:function(a,b,c){console.log("Error fetching Favorites data to sync stars"),Artbot.errors.logAjaxError(a,b,c)}})},highlightStar:function(a,b){var c=$(a),d=c.find(".icon");d.removeClass("icon-star").addClass("icon-star2"),c.attr("data-user-favorite-id",b)},unhighlightStar:function(a){var b=$(a),c=b.find(".icon");c.removeClass("icon-star2").addClass("icon-star"),b.removeAttr("data-user-favorite-id")}},Artbot.setupTextTruncation=function(){$(".truncate").trunk8({lines:2,tooltip:!1}),Artbot.el.win.resize(function(){$(".truncate").trunk8({lines:2,tooltip:!1})})},Artbot.signupModal={vars:{returnToPage:""},init:function(){$(document).on("click",".signup-trigger",function(){Artbot.signupModal.open()})},ajaxSubmit:function(){$.mobile.loading("show"),$.ajax({type:"POST",dataType:"json",url:Artbot["var"].jsonDomain+"/registrations",data:{email:$("#email").val(),password:$("#password").val(),password_confirmation:$("#confirmpassword").val(),zipcode:$("#zipcode").val()},beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){localStorage.authentication_token=a.user.authentication_token,localStorage.current_user=$("#email").val(),localStorage.signed_up=!0,$.mobile.pageContainer.pagecontainer("change","interests.html",{reloadPage:!0})},error:function(a,b,c){console.log("User registration failed"),Artbot.errors.logAjaxError(a,b,c),Artbot.errors.showFormError(a.responseText,"signup-form"),$.mobile.loading("hide")}})},open:function(){Artbot.signupModal.vars.returnToPage="/sign-in.html"!=$(".ui-page-active").attr("data-url")?$(".ui-page-active").attr("data-url"):"/",$.mobile.loading("show"),$("#signup-form").load("/signup-form.html",function(a,b,c){"error"==status?(console.log("Failed to load the signup form into the modal"),Artbot.errors.logAjaxError(a,b,c)):($("#signup-form").trigger("create"),$("#signup-popup").popup("open"),$("#signup-form").validate({submitHandler:Artbot.signupModal.ajaxSubmit})),$.mobile.loading("hide")})},close:function(){$("#signup-form").empty()}},Artbot.customCheckboxes={init:function(a){var b;b=void 0!==a&&null!==a?$(a).find(".customize-checkbox"):$(".customize-checkbox"),b.length>0&&(console.log("Setting up custom checkboxes"),b.customInput())
},destroy:function(a){var b;b=void 0!==a&&null!==a?$(a).find(".customize-checkbox"):$(".customize-checkbox"),b.length>0&&(console.log("Destroying custom checkboxes"),b.customInput("destroy"))}},Artbot.eventdetail={init:function(){$("#template-eventdetail").length>0&&Artbot.eventdetail.initPage()},initPage:function(){$.mobile.loading("show");var a=Artbot.util.findQuerystring("eventid");"undefined"!=typeof a&&(Artbot["var"].eventDetailID=a),$.ajax({type:"GET",dataType:"json",data:{related:!0},url:Artbot["var"].jsonDomain+"/events/"+Artbot["var"].eventDetailID,beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){var b=a;Artbot["var"].relatedInterests=a.event.related,Artbot.eventdetail.displayPage(b)},error:function(a,b,c){console.log("Event detail data fetch failed"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},displayPage:function(a){var b=a,c=$("#template-eventdetail").html();$("h1").find("a").text(b.event.event_type.capitalize()),$("#target-eventdetail").fadeOut(400,function(){$("#target-eventdetail").html(_.template(c,{eventArray:b})),Artbot.favoriteStars.init(),$("#target-eventdetail").fadeIn(400),Artbot.footerSlider.init()})}},Artbot.venuedetail={init:function(){$("#template-venuedetail").length>0&&Artbot.venuedetail.initPage()},initPage:function(){$.mobile.loading("show");var a=Artbot.util.findQuerystring("venueid");"undefined"!=typeof a&&(Artbot["var"].venueDetailID=a),$.ajax({type:"GET",dataType:"json",data:{related:!0},url:Artbot["var"].jsonDomain+"/locations/"+Artbot["var"].venueDetailID,beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){var b=a;Artbot.venuedetail.displayPage(b)},error:function(a,b,c){console.log("Venue detail data fetch failed"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},displayPage:function(a){var b=a,c=$("#template-venuedetail").html();$("#target-venuedetail").fadeOut(400,function(){$("#target-venuedetail").html(_.template(c,{venueArray:b})),$("#target-venuedetail").fadeIn(400),Artbot.footerSlider.init()})}},Artbot.calendar={getEvents:function(a,b){var c=Artbot["var"].jsonDomain+"/events";$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",data:{year:b,month:a,per_page:1e3},url:c,beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){eventArray=a.events,Artbot.el.eventCalendar=$("#event-calendar").clndr({template:$("#template-calendar").html(),events:eventArray,dateParameter:"start_date",multiDayEvents:{startDate:"start_date",endDate:"end_date"},clickEvents:{click:function(a){if($(a.element).hasClass("day")){$(".day").removeClass("day-selected"),$(a.element).addClass("day-selected");var b=JSON.stringify(a.events);b.length>2?Artbot.calendar.displayEventList(a):Artbot.calendar.showErrorMsg("noevents")}},onMonthChange:function(a){var b=a.format("MM"),c=a.format("YYYY"),d=Artbot["var"].jsonDomain+"/events",e=[];$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",url:d,data:{year:c,month:b,per_page:1e3},beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){e=a.events,Artbot.el.eventCalendar.setEvents(e)},error:function(a,d,e){console.log("Events for "+b+" "+c+" failed"),Artbot.errors.logAjaxError(a,d,e)},complete:function(){$.mobile.loading("hide")}})}},doneRendering:function(){var a=moment().format("MMMM"),b=moment().format("YYYY"),c=a+" "+b,d=$(".clndr-controls").find(".month").html();c==d?$(".day.today").trigger("click"):$(".last-month").last().next().length>0?$(".last-month").last().next().trigger("click"):$(".day").first().trigger("click")}})},error:function(a,b,c){console.log("Initial calendar event fetch failed"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},displayEventList:function(a){$("#event-list-messages").find("p").fadeOut(400);var b=a.events,c=$("#template-eventlist").html();$("#event-list").fadeOut(400,function(){$("#event-list").html(_.template(c,{eventArray:b})),Artbot.favoriteStars.init(),$("#event-list").fadeIn(400,function(){Artbot.setupTextTruncation()})})},showErrorMsg:function(a){$("#event-list").fadeOut(400,function(){$("#event-list").empty().show()}),$("#event-list-msg-"+a).fadeIn(400)},init:function(){if($("#event-calendar").length>0){var a=moment().month(),b=moment().year();a++,Artbot.calendar.getEvents(a,b)}}},Artbot.loadMore={vars:{loadMoreLink:$("#load-more"),nextPageJsonURL:"",itemContainer:"",itemTemplate:$("#item-template").html(),currentPage:1,nextPage:2},setupLoadMoreLink:function(){Artbot.loadMore.vars.loadMoreLink.removeClass("btn-hidden").click(function(){$.mobile.loading("show"),Artbot.loadMore.vars.loadMoreLink.fadeOut();var a,b,c=Artbot.loadMore.vars.loadMoreLink.data("feed");switch(c){case"/GetEventsByLocation/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/getEventsByLocation-page"+Artbot.loadMore.vars.nextPage+".json";break;case"/LoadFavorites/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page"+Artbot.loadMore.vars.nextPage+".json";break;default:Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page"+Artbot.loadMore.vars.nextPage+".json"}$.getJSON(Artbot.loadMore.vars.nextPageJsonURL,function(c){a=c,b=$(_.template(Artbot.loadMore.vars.itemTemplate,{jsonArray:a})).hide(),b.appendTo(Artbot.loadMore.vars.itemContainer),b.fadeIn(),Artbot.setupTextTruncation(),Artbot.loadMore.vars.currentPage=Artbot.loadMore.vars.nextPage,Artbot.loadMore.vars.nextPage=Artbot.loadMore.vars.nextPage+1;var d=(Artbot.util.getNumberOfChildItems(Artbot.loadMore.vars.itemContainer),Artbot.loadMore.vars.loadMoreLink.data("feed"));switch(d){case"/GetEventsByLocation/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/getEventsByLocation-page"+Artbot.vars.nextPageJsonURL+".json";break;case"/LoadFavorites/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page"+Artbot.loadMore.vars.nextPage+".json";break;default:Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page"+Artbot.loadMore.vars.nextPage+".json"}Artbot.dataService.getJsonFeed(Artbot.loadMore.vars.nextPageJsonURL,function(a){var b=Artbot.util.isThereMore(a);b&&Artbot.loadMore.vars.loadMoreLink.fadeIn()}),$.mobile.loading("hide")})})},init:function(){if(Artbot.loadMore.vars.loadMoreLink.length>0){console.log("Initializing Load More functionality"),Artbot.loadMore.vars.itemContainer=Artbot.loadMore.vars.loadMoreLink.prev();var a=Artbot.util.getNumberOfChildItems(Artbot.loadMore.vars.itemContainer);if(a==Artbot["var"].itemsPerPage){var b=Artbot.loadMore.vars.loadMoreLink.data("feed");switch(b){case"/GetEventsByLocation/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/getEventsByLocation-page2.json";break;case"/LoadFavorites/":Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page2.json";break;default:Artbot.loadMore.vars.nextPageJsonURL="/ui/js/json/loadFavorites-page2.json"}Artbot.dataService.getJsonFeed(Artbot.loadMore.vars.nextPageJsonURL,function(a){var b=Artbot.util.isThereMore(a);b&&Artbot.loadMore.setupLoadMoreLink()})}}}},Artbot.settings={init:function(){if("undefined"==typeof localStorage.remember_me&&"undefined"!=typeof localStorage.current_user)Artbot.settings.setRememberMe(localStorage.current_user,!0);else if("undefined"!=typeof localStorage.remember_me&&"undefined"!=typeof localStorage.current_user){var a=Artbot.settings.getRememberMe(localStorage.current_user);console.log("User setting: "+a),"undefined"==typeof a&&(console.log("Setting a default Remember Me value for "+localStorage.current_user),Artbot.settings.setRememberMe(localStorage.current_user,!0))}if($("#settings-form").length>0){var b=Artbot.util.getAuthToken();"undefined"!=typeof b&&(Artbot.settings.fetchFieldValues(),$("#settings-form").validate({rules:{password_confirmation:{equalTo:"#password"},email:"email",zipcode:"zipcode"},submitHandler:Artbot.settings.ajaxSubmit}))}},setRememberMe:function(a,b){var c=b,d=a,e=JSON.parse(localStorage.getItem("remember_me"));null===e&&(e={}),console.log("Existing Remember Me data: "+JSON.stringify(e)),e[d]=c,console.log("New Remember Me data: "+JSON.stringify(e)),localStorage.remember_me=JSON.stringify(e)},getRememberMe:function(a){var b,c=a,d=JSON.parse(localStorage.getItem("remember_me"));return null===d&&(d={}),b=d[c]},swapLocalAndSession:function(a){var b=a;b===!1&&"undefined"!=typeof localStorage.authentication_token?(console.log("Switching to sessionStorage"),sessionStorage.authentication_token=localStorage.authentication_token,sessionStorage.current_user=$("#email").val(),localStorage.removeItem("authentication_token"),localStorage.removeItem("current_user"),Artbot.settings.setRememberMe(sessionStorage.current_user,!1)):b===!0&&"undefined"!=typeof sessionStorage.authentication_token&&(console.log("Switching to localStorage"),localStorage.authentication_token=sessionStorage.authentication_token,localStorage.current_user=$("#email").val(),sessionStorage.removeItem("authentication_token"),sessionStorage.removeItem("current_user"),Artbot.settings.setRememberMe(localStorage.current_user,!0))},bindCustomCheckboxes:function(){Artbot.customCheckboxes.init("#settings-form")},unbindCustomCheckboxes:function(){Artbot.customCheckboxes.destroy("#settings-form")},fetchFieldValues:function(){var a=Artbot.util.getAuthToken();$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/preferences/",beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){Artbot.settings.populateFieldValues(a)},error:function(a,b,c){console.log("Error retrieving user preferences"),Artbot.errors.logAjaxError(a,b,c)}})},populateFieldValues:function(a){var b=a.user,c=$("#settings-form").find("input");document.getElementById("settings-form").reset(),Artbot.settings.unbindCustomCheckboxes(),c.each(function(){var a=$(this).attr("id");void 0!==b[a]&&("flipswitch"==$(this).attr("data-role")?b[a]===!0&&$(this).attr("checked","checked").flipswitch("refresh"):$(this).val(b[a]))});var d,e=b.remember_created_at,f=$("#remember_me");console.log("Remember Me Date: "+e),null!==e?(d=!0,f.prop("checked")!==!0&&f.prop("checked",!0)):(d=!1,f.prop("checked")===!0&&f.prop("checked",!1)),Artbot.settings.bindCustomCheckboxes(),Artbot.settings.swapLocalAndSession(d);var g=$("#settings-form").find("input[data-role=flipswitch]");g.change(function(){Artbot.settings.toggleThisOption(this)})},toggleThisOption:function(a){console.log("Toggling checkbox value"),$thisCheckbox=$(a);var b=$thisCheckbox.prop("checked"),c=$(a).prop("id");console.log("Value of property 'checked': "+b);var d={};d[c]=b;var e=Artbot.util.getAuthToken();$.mobile.loading("show"),$.ajax({type:"PUT",url:Artbot["var"].jsonDomain+"/preferences/",data:d,beforeSend:function(a){a.setRequestHeader("authentication_token",e),a.setRequestHeader("accept","application/json")},success:function(){console.log("Toggle change successfully saved")},error:function(a,b,c){console.log("Error sending toggle Ajax call"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},ajaxSubmit:function(){var a,b=$("#settings-form"),c=b.serializeArray(),d={};for(var e in c)"remember_me"!=c[e].name&&(d[c[e].name]=c[e].value);var f=$("#remember_me");a=f.prop("checked")===!0?!0:!1,d.remember_me=a,$.mobile.loading("show");var g=Artbot.util.getAuthToken();$.ajax({type:"PATCH",url:Artbot["var"].jsonDomain+"/preferences/",data:d,beforeSend:function(a){a.setRequestHeader("authentication_token",g),a.setRequestHeader("accept","application/json")},success:function(){console.log("All user preferences successfully saved"),Artbot.settings.swapLocalAndSession(a)},error:function(a,b,c){console.log("Error saving all user preferences"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})}},Artbot.historyList={vars:{historyData:[]},init:function(){if($("#target-historylist").length>0){var a=Artbot.util.getAuthToken();void 0!==typeof a&&(console.log("Initializing History list"),Artbot.historyList.fetchData())}},fetchData:function(){$.mobile.loading("show");var a=Artbot.util.getAuthToken();$.ajax({type:"GET",dataType:"json",url:Artbot["var"].jsonDomain+"/favorites/history/",data:{page:1,per_page:1e4},beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){console.log("Successfully fetched History data"),Artbot.historyList.vars.historyData=a,jsonDataString=JSON.stringify(Artbot.historyList.vars.historyData.favorites),jsonDataString.length>2?(Artbot.historyList.hideErrorMsg(),$("#target-historylist").fadeOut(400,function(){Artbot.historyList.buildList(Artbot.historyList.vars.historyData)})):Artbot.historyList.showErrorMsg()},error:function(a,b,c){console.log("Error fetching History data"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},buildList:function(a){console.log("Building history list");var b,c=a.favorites,d=$("#template-historylist").html();b=_.template(d,{jsonArray:c}),$(b).appendTo($("#target-historylist")),Artbot.historyList.unbindAttendanceCheckboxes(),Artbot.historyList.addEventHandlers(),Artbot.historyList.showList()},addEventHandlers:function(){Artbot.historyList.syncAttended(),Artbot.favoriteStars.init()},showList:function(){$("#target-historylist").fadeIn(400,function(){Artbot.setupTextTruncation()})},showErrorMsg:function(){$("#error-historylist").find("p").fadeIn(400)},hideErrorMsg:function(){$("#error-historylist").find("p").fadeOut(400)},removeFavorite:function(a){$("#target-historylist").fadeOut(400,function(){$("#target-historylist").find("a[data-event-id="+a+"]").parents(".item-block").remove();var b=$("#target-historylist").children(".item-block").length;console.log("Number of history items left: "+b),0===b&&Artbot.historyList.showErrorMsg(),Artbot.historyList.showList()})},bindAttendanceCheckboxes:function(){Artbot.customCheckboxes.init("#history-form"),$("#history-form").find("input[type=checkbox]").click(function(){Artbot.historyList.toggleAttended($(this))})},unbindAttendanceCheckboxes:function(){Artbot.customCheckboxes.destroy("#history-form"),$("#history-form").find("input[type=checkbox]").unbind("click")},toggleAttended:function(a){console.log("Toggling 'Attended?' checkbox value"),$thisCheckbox=$(a);var b=$thisCheckbox.prop("checked"),c=($(a).attr("data-event-id"),$(a).attr("data-user-favorite-id"));console.log("User favorite: "+c+", Value of property 'checked': "+b);var d={attended:b};$.mobile.loading("show");var e=Artbot.util.getAuthToken();$.ajax({type:"PUT",url:Artbot["var"].jsonDomain+"/favorites/"+c,data:d,beforeSend:function(a){a.setRequestHeader("authentication_token",e),a.setRequestHeader("accept","application/json")},success:function(){console.log("Attendance data successfully saved")},error:function(a,b,c){console.log("Error sending Attendance Ajax call"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},syncAttended:function(){if($("#history-form").find("input[type=checkbox]").length>0&&(console.log("Syncing attendance checkboxes with user's attended records"),document.getElementById("history-form").reset(),jsonDataString=JSON.stringify(Artbot.historyList.vars.historyData.favorites),jsonDataString.length>2)){var a=Artbot.historyList.vars.historyData.favorites;$.each(a,function(b){var c,d=a[b];if(console.log("Checking user favorite "+d.id+"; This event attended? "+d.attended),c=d.attended===!0?!0:!1){console.log("Since this event is attended, toggle the checkbox to be checked.");var e=d.id,f=$("#history-form").find("input[data-user-favorite-id="+e+"]");f.prop("checked")!==!0&&(f.prop("checked",!0).trigger("updateState"),console.log("Double-checking: is the checkbox checked as expected after the click event? "+f.prop("checked")))}});var b=$("#history-form").find(".customize-checkbox");console.log("Double-checking all the checkbox values now that things are synched:"),$.each(b,function(){var a=$(this).prop("checked"),b=$(this).attr("data-user-favorite-id");console.log("User favorite: "+b+", Value of property 'checked' after syncing: "+a)}),Artbot.historyList.bindAttendanceCheckboxes()}}},Artbot.favoriteList={init:function(){if($("#target-favoritelist").length>0){var a=Artbot.util.getAuthToken();void 0!==typeof a&&Artbot.favoriteList.fetchData()}},fetchData:function(){var a=Artbot.util.getAuthToken();$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",url:Artbot["var"].jsonDomain+"/favorites/",data:{page:1,per_page:1e4},beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){jsonDataString=JSON.stringify(a.favorites),jsonDataString.length>2?(Artbot.favoriteList.hideErrorMsg(),$("#target-favoritelist").fadeOut(400,function(){Artbot.favoriteList.buildList(a),Artbot.favoriteList.showList()})):Artbot.favoriteList.showErrorMsg()},error:function(a,b,c){console.log("Error fetching Favorites data"),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})},buildList:function(a){var b,c=a.favorites,d=$("#template-favoritelist").html();b=_.template(d,{jsonArray:c}),$(b).appendTo($("#target-favoritelist")),Artbot.favoriteList.addEventHandlers()},addEventHandlers:function(){Artbot.favoriteStars.init()},showList:function(){$("#target-favoritelist").fadeIn(400)},showErrorMsg:function(){$("#error-favoritelist").find("p").fadeIn(400)},hideErrorMsg:function(){$("#error-favoritelist").find("p").fadeOut(400)},removeFavorite:function(a){$("#target-favoritelist").fadeOut(400,function(){$("#target-favoritelist").find("a[data-event-id="+a+"]").parents(".item-block").remove();var b=$("#target-favoritelist").children(".item-block").length;0===b&&Artbot.favoriteList.showErrorMsg(),Artbot.favoriteList.showList()})}},Artbot.interests={vars:{ajaxType:"GET",ajaxURL:Artbot["var"].jsonDomain+"/possible_interests/",ajaxData:"",ajaxSuccessMsg:"Successfully retrieved full list of possible interests",ajaxErrorMsg:"Retrieval of full possible interest list failed",ajaxCallback:function(){},interestIntro:"#interest-onboarding-intro"},init:function(){if($("#interest-form").length>0){var a=Artbot.util.getAuthToken();if(void 0!==typeof a){console.log("Initializing functionality for My Interests"),Artbot.interests.checkForInterests();var b,c,d=!1;$("#interest-form-list").on("click","input[type=checkbox]",function(){if(d=$(this).prop("checked"),b=$(this).data("interest-id"),checkboxValue=$(this).val(),c=$(this),d)Artbot.interests.vars.ajaxType="POST",Artbot.interests.vars.ajaxURL=Artbot["var"].jsonDomain+"/interests/",Artbot.interests.vars.ajaxData={tag_id:b},Artbot.interests.vars.ajaxSuccessMsg="Interest '"+checkboxValue+"' saved.",Artbot.interests.vars.ajaxErrorMsg="Saving interest '"+checkboxValue+"' failed!",Artbot.interests.vars.ajaxCallback=function(a,b){console.log("Callback for adding an interest");var c,d=a;$.each(b,function(a,b){c=b.id,console.log("Selected interest ID for this user: "+c)}),d.attr("data-user-interest-id",c)};else{var e=$(this).data("user-interest-id");console.log("userInterestID: "+e),Artbot.interests.vars.ajaxType="POST",Artbot.interests.vars.ajaxURL=Artbot["var"].jsonDomain+"/interests/"+e,Artbot.interests.vars.ajaxData={_method:"delete"},Artbot.interests.vars.ajaxSuccessMsg="Interest '"+checkboxValue+"' deleted.",Artbot.interests.vars.ajaxErrorMsg="Deleting interest '"+checkboxValue+"' failed!",Artbot.interests.vars.ajaxCallback=function(a){console.log("Callback for deleting an interest");var b=a;b.removeAttr("data-user-interest-id")}}$.mobile.loading("show"),$.ajax({type:Artbot.interests.vars.ajaxType,url:Artbot.interests.vars.ajaxURL,data:Artbot.interests.vars.ajaxData,beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){console.log(Artbot.interests.vars.ajaxSuccessMsg),Artbot.interests.vars.ajaxCallback(c,a)},error:function(a,b,c){console.log(Artbot.interests.vars.ajaxErrorMsg),Artbot.errors.logAjaxError(a,b,c)},complete:function(){$.mobile.loading("hide")}})})}}},destroy:function(){$("#interest-form").length>0&&(console.log("Destroying interest checkbox click events"),$("#interest-form-list").off("click"))},checkForInterests:function(){console.log("Checking for user interests"),Artbot.interests.vars.ajaxType="GET",Artbot.interests.vars.ajaxURL=Artbot["var"].jsonDomain+"/interests/",Artbot.interests.vars.ajaxSuccessMsg="Successfully checked list of user's interests",Artbot.interests.vars.ajaxErrorMsg="Check of user's interest list failed";var a=Artbot.util.getAuthToken();$.ajax({type:Artbot.interests.vars.ajaxType,url:Artbot.interests.vars.ajaxURL,beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){console.log(Artbot.interests.vars.ajaxSuccessMsg),$.mobile.loading("show"),a.interests&&a.interests.length?(console.log("User has interests!"),Artbot.interests.vars.interestIntro="#interest-normal-intro",$("#interest-form-list").fadeOut(400,function(){Artbot.interests.getUserInterests()})):(console.log("User has no interests yet"),Artbot.interests.vars.interestIntro="#interest-onboarding-intro",$("#interest-form-list").fadeOut(400,function(){Artbot.interests.getAllInterests()}))},error:function(a,b,c){console.log(Artbot.interests.vars.ajaxErrorMsg),Artbot.errors.logAjaxError(a,b,c)}})},buildInterestList:function(a,b){console.log("Building interest list");var c,d=a;c=b?_.template($("#interests-user-template").html(),{jsonArray:d}):_.template($("#interests-template").html(),{jsonArray:d}),$(c).appendTo($("#interest-form-list"))},showList:function(){var a=$(Artbot.interests.vars.interestIntro);console.log("Showing finished interest list"),Artbot.customCheckboxes.init("#interest-form-list"),$.mobile.loading("hide"),a.fadeIn(400),$("#interest-form-list").fadeIn(400)},getAllInterests:function(){$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/possible_interests/",beforeSend:function(a){a.setRequestHeader("accept","application/json"),a.setRequestHeader("accept","application/json")},success:function(a){console.log("Successfully retrieved full list of possible interests"),Artbot.interests.buildInterestList(a,!1),Artbot.interests.showList()},error:function(a,b,c){console.log("Retrieval of full possible interest list failed"),Artbot.errors.logAjaxError(a,b,c)}})},getUncheckedInterests:function(){var a={};a.tags=[];var b=Artbot["var"].jsonDomain+"/possible_interests/";return $.ajax({type:"GET",url:b,beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(b){console.log("Successfully retrieved full list of interests for subsetting"),allTags=b.tags;var c=Artbot.util.getAuthToken();$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/interests/",beforeSend:function(a){a.setRequestHeader("authentication_token",c),a.setRequestHeader("accept","application/json")},success:function(b){for(console.log("Successfully retrieved list of user's interests for subsetting"),selectedInterests=b.interests,i=0;i<allTags.length;i++)for(tag=allTags[i],a.tags.push(tag),j=0;j<selectedInterests.length;j++)interest=selectedInterests[j],tag.id===interest.tag.id&&(a.tags.pop(),selectedInterests.splice(j,1));Artbot.interests.buildInterestList(a,!1),Artbot.interests.showList()},error:function(a,b,c){console.log("Failed retrieving selected interests feed for subsetting"),Artbot.errors.logAjaxError(a,b,c)}})},error:function(a,b,c){console.log("Failed retrieving all tags feed for subsetting"),Artbot.errors.logAjaxError(a,b,c)}}),a},getUserInterests:function(){var a=Artbot.util.getAuthToken();$.ajax({type:"GET",url:Artbot["var"].jsonDomain+"/interests/",beforeSend:function(b){b.setRequestHeader("authentication_token",a),b.setRequestHeader("accept","application/json")},success:function(a){console.log("Successfully retrieved list of user's interests"),Artbot.interests.buildInterestList(a,!0),Artbot.interests.getUncheckedInterests()},error:function(a,b,c){console.log("Retrieval of user's interest list failed"),Artbot.errors.logAjaxError(a,b,c)}})}},Artbot.login={init:function(){$("#signin-form").length>0&&(console.log("Initializing sign-in form"),$("#signin-form").validate({submitHandler:Artbot.login.ajaxSubmit})),$(".signin-link").click(function(){Artbot.signupModal.vars.returnToPage=$(".ui-page-active").attr("data-url"),"/forgot"==Artbot.signupModal.vars.returnToPage.substring(0,7)&&(Artbot.signupModal.vars.returnToPage="/")})},ajaxSubmit:function(){$.mobile.loading("show"),$.ajax({type:"POST",dataType:"json",url:Artbot["var"].jsonDomain+"/tokens/",data:{email:$("#signin-email").val(),password:$("#signin-password").val()},beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){console.log("Login successful! Saving our signin info");var b=$("#signin-email").val(),c=Artbot.settings.getRememberMe(b);c===!1?(console.log("Remember Me: false; using sessionStorage"),sessionStorage.authentication_token=a.authentication_token,sessionStorage.current_user=$("#signin-email").val()):(console.log("Remember Me: true; using localStorage"),localStorage.authentication_token=a.authentication_token,localStorage.current_user=$("#signin-email").val()),"undefined"==typeof localStorage.signed_up&&(console.log("Adding a 'signed_up' localStorage variable"),localStorage.signed_up=!0),Artbot.el.html.hasClass("is-logged-in")||Artbot.el.html.addClass("is-logged-in"),console.log("Return to page value: "+Artbot.signupModal.vars.returnToPage),void 0!==Artbot.signupModal.vars.returnToPage&&""!==Artbot.signupModal.vars.returnToPage?$.mobile.pageContainer.pagecontainer("change",Artbot.signupModal.vars.returnToPage,{reloadPage:!0}):$.mobile.pageContainer.pagecontainer("change","/",{reloadPage:!0})},error:function(a,b,c){if(console.log("User login submit failed"),Artbot.errors.logAjaxError(a,b,c,!0),403==a.status||404==a.status||422==a.status){var d,e,f,g,h=$.parseJSON(a.responseText);$.each(h,function(a,b){d=a.capitalize()+" "+b.toString(),console.log("Error text: "+d),"email"==a?(e=$("#signin-email"),f="signin-email"):"password"==a&&(e=$("#signin-password"),f="signin-password"),$("#"+f+"-error").length>0?(console.log("Error already exists"),g=$("#signin-password-error"),g.html(d).show()):(console.log("Error is new"),g=$("<label>").attr("id","#"+f+"-error").addClass("error").html(d).attr("for",f),g.insertAfter(e)),e.removeClass("valid").addClass("error").attr("aria-invalid",!0)})}else Artbot.errors.showFormError(a.responseText,"signin-form")},complete:function(){$.mobile.loading("hide")}})}},Artbot.logout={init:function(){$(".action-logout").click(function(){console.log("Log out link clicked!"),Artbot.signupModal.vars.returnToPage="",localStorage.removeItem("authentication_token"),localStorage.removeItem("current_user"),sessionStorage.removeItem("authentication_token"),sessionStorage.removeItem("current_user"),Artbot.el.html.removeClass("is-logged-in"),$.mobile.pageContainer.pagecontainer("change","/",{reloadPage:!0})})}},Artbot.geolocation={vars:{currentLatitude:"",currentLongitude:""},successCallback:function(){},failureCallback:function(){},getLocation:function(a,b){Artbot.geolocation.successCallback=a,Artbot.geolocation.failureCallback=b,navigator.geolocation?($.mobile.loading("show"),navigator.geolocation.getCurrentPosition(Artbot.geolocation.storePosition,Artbot.geolocation.showError)):(console.log("Geolocation is not supported by this browser."),Artbot.geolocation.failureCallback())},storePosition:function(a){console.log("Storing latitude: "+a.coords.latitude+", Longitude: "+a.coords.longitude),Artbot.geolocation.vars.currentLatitude=a.coords.latitude,Artbot.geolocation.vars.currentLongitude=a.coords.longitude,Artbot.geolocation.successCallback()},showError:function(a){switch(console.log("Geolocation error:"),a.code){case a.PERMISSION_DENIED:console.log("User denied the request for Geolocation.");break;case a.POSITION_UNAVAILABLE:console.log("Location information is unavailable.");break;case a.TIMEOUT:console.log("The request to get user location timed out.");break;case a.UNKNOWN_ERROR:console.log("An unknown error occurred.")}Artbot.geolocation.failureCallback()}},Artbot.byLocation={vars:{mapContainer:"event-map",locationData:{},openWithVenueID:"-1",accessToken:"pk.eyJ1IjoiYXRvc2NhIiwiYSI6IlFSSDhOU0EifQ.8j2CBSsaQQmn-Ic7Vjx1bw",mapInstance:"",boundsArray:[],markers:[]},init:function(){if($("#event-map").length>0){console.log("Initializing map"),Artbot.byLocation.vars.openWithVenueID="-1";var a=Artbot.util.findQuerystring("venueid");"undefined"!=typeof a&&(Artbot.byLocation.vars.openWithVenueID=a),L.mapbox.accessToken=Artbot.byLocation.vars.accessToken,Artbot.byLocation.vars.mapInstance=L.mapbox.map(Artbot.byLocation.vars.mapContainer,"sherrialexander.jepo6la8"),Artbot.byLocation.fetchLocations()}},fetchLocations:function(){$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",data:{per_page:1e3},url:Artbot["var"].jsonDomain+"/locations/",beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){console.log("Map data successfully fetched"),Artbot.byLocation.vars.locationData=a.locations,Artbot.byLocation.buildMap(),Artbot.byLocation.showMap()},error:function(a,b,c){console.log("User login submit failed"),Artbot.errors.logAjaxError(a,b,c,!0)},complete:function(){$.mobile.loading("hide")}})},fetchSingleLocation:function(a){$.mobile.loading("show"),$.ajax({type:"GET",dataType:"json",data:{per_page:10},url:Artbot["var"].jsonDomain+"/locations/"+a+"/events",beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(a){console.log("Event data successfully fetched");var b=JSON.stringify(a.events);b.length>2?(console.log("This venue has events"),Artbot.byLocation.showEventList(a.events)):(console.log("No events at this venue"),Artbot.byLocation.showErrorMsg("noevents"))},error:function(a,b,c){console.log("Fetch of event data failed"),Artbot.errors.logAjaxError(a,b,c,!0)},complete:function(){$.mobile.loading("hide")}})},buildMap:function(){$.each(Artbot.byLocation.vars.locationData,function(){var a=this.name,b=this.id;Artbot.byLocation.vars.boundsArray.push([this.latitude,this.longitude]),Artbot.byLocation.vars.markers[b]=L.marker([this.latitude,this.longitude],{icon:L.mapbox.marker.icon({"marker-color":"#20a9b3"})}),Artbot.byLocation.vars.markers[b].bindPopup(a).openPopup(),Artbot.byLocation.vars.markers[b].on("click",function(){Artbot.byLocation.fetchSingleLocation(b)}),Artbot.byLocation.vars.markers[b].addTo(Artbot.byLocation.vars.mapInstance)})},showErrorMsg:function(a){$("#event-list").fadeOut(400,function(){$("#event-list").empty().show()}),$("#event-list-msg-"+a).fadeIn(400)},showEventList:function(a){$("#event-list-messages").find("p").fadeOut(400),$("#event-list").fadeOut(400,function(){$("#event-list").empty().html(_.template($("#template-eventlist").html(),{eventArray:a})),Artbot.byLocation.addEventHandlers(),$("#event-list").fadeIn(400,function(){Artbot.setupTextTruncation()})})},addEventHandlers:function(){Artbot.favoriteStars.init()},showMap:function(){if(-1!=Artbot.byLocation.vars.openWithVenueID){console.log("Show a map for venue ID "+Artbot.byLocation.vars.openWithVenueID);var a=42.3581,b=-71.0636;$.each(Artbot.byLocation.vars.locationData,function(c,d){d.id==Artbot.byLocation.vars.openWithVenueID&&(a=d.latitude,b=d.longitude)}),Artbot.byLocation.vars.mapInstance.setView([a,b],16,{animate:!0}),Artbot.byLocation.vars.markers[Artbot.byLocation.vars.openWithVenueID].openPopup(),Artbot.byLocation.fetchSingleLocation(Artbot.byLocation.vars.openWithVenueID)}else console.log("Show map zoomed to show all locations"),Artbot.byLocation.vars.mapInstance.setView([42.3581,-71.0636],12);Artbot.footerSlider.init()}},Artbot.webAppStatusBar={init:function(){window.navigator.standalone&&$("html").addClass("standalone-app"),navigator.userAgent.match(/(iPad|iPhone|iPod touch);.*CPU.*OS 7_\d/i)&&$("html").addClass("ios7")
}},Artbot.forgotPassword={init:function(){$("#forgotpassword-form").length>0&&$("#forgotpassword-form").validate({submitHandler:Artbot.forgotPassword.ajaxSubmit})},ajaxSubmit:function(){$.mobile.loading("show"),$.ajax({type:"PATCH",url:Artbot["var"].jsonDomain+"/registrations/",data:{email:$("#email").val()},beforeSend:function(a){a.setRequestHeader("accept","application/json")},success:function(){console.log("Password reset request sent"),$.mobile.pageContainer.pagecontainer("change","forgot-password-confirm.html",{reloadPage:!0})},error:function(a,b,c){if(console.log("Error sending password reset request"),Artbot.errors.logAjaxError(a,b,c),404==a.status){var d,e;d="Email address not found in our system.",$("#email-error").length>0?(e=$("#email-error"),e.addClass("error").html(d).show()):(e=$("<label>").attr("id","email-error").addClass("error").html(d).attr("for","email"),e.insertAfter($("#email"))),$("#email").addClass("error")}},complete:function(){$.mobile.loading("hide")}})}},Artbot.resetPassword={token:"",init:function(){$("#passwordreset-form").length>0&&(console.log("Initializing Reset Password form"),Artbot.resetPassword.token=Artbot.util.findQuerystring("reset_password_token"),"undefined"!=typeof Artbot.resetPassword.token&&(console.log("Reset password token passed in via querystring: "+Artbot.resetPassword.token),$("#passwordreset-form").validate({submitHandler:Artbot.resetPassword.ajaxSubmit})))},ajaxSubmit:function(){$.mobile.loading("show"),$.ajax({type:"PUT",url:Artbot["var"].jsonDomain+"/registrations",data:{password:$("#password").val(),password_confirmation:$("#password_confirmation").val()},beforeSend:function(a){a.setRequestHeader("reset_password_token",Artbot.resetPassword.token),a.setRequestHeader("accept","application/json")},success:function(){console.log("Password reset successful"),$.mobile.pageContainer.pagecontainer("change","forgot-password-reset-confirm.html",{reloadPage:!0})},error:function(a){console.log("Error resetting password"),Artbot.errors.showFormError(a.responseText,"passwordreset-form")},complete:function(){$.mobile.loading("hide")}})}},Artbot.startup={init:function(){$('a[href="#"]').click(function(a){a.preventDefault()}),Artbot.webAppStatusBar.init(),Artbot.discoverSlider.init(),Artbot.login.init(),Artbot.logout.init(),Artbot.forgotPassword.init(),Artbot.resetPassword.init(),Artbot.interests.init(),Artbot.calendar.init(),Artbot.settings.init(),Artbot.byLocation.init(),Artbot.eventdetail.init(),Artbot.venuedetail.init(),Artbot.favoriteList.init(),Artbot.historyList.init(),Artbot.loadMore.init(),Artbot.setupTextTruncation(),Artbot.favoriteStars.init()},finalize:function(){FastClick.attach(document.body);var a=Artbot.util.getAuthToken(),b=Artbot.util.getCurrentUser(),c=localStorage.signed_up,d=localStorage.prior_visit;console.log("Auth token: "+a),console.log("Current user: "+b),console.log("Signed up: "+c),console.log("Prior visit: "+d),"undefined"==typeof a&&"undefined"==typeof c&&"/sign-in.html"!=$(".ui-page-active").attr("data-url")&&"/forgot"!=$(".ui-page-active").attr("data-url").substring(0,7)&&($("#discover-slider").length>0?(console.log("Popping the new visitor sign up window"),setTimeout(function(){Artbot.signupModal.open()},1e3)):"undefined"==typeof d&&(console.log("Popping the new visitor sign up window"),setTimeout(function(){Artbot.signupModal.open()},1e3))),"undefined"!=typeof a&&(Artbot.el.html.hasClass("is-logged-in")||Artbot.el.html.addClass("is-logged-in"),$(".dynamic-username").length>0&&$(".dynamic-username").html(b))}},$(document).ready(function(){handleAppCache(),$("#signup-popup").enhanceWithin().popup({history:!1,positionTo:"window",afterclose:Artbot.signupModal.close}),Artbot.signupModal.init()}),$(document).on("mobileinit",function(){console.log("****JQM mobileinit event firing"),$.mobile.popup.prototype.options.history=!1}),$(document).on("pagebeforehide",function(){Artbot.footerSlider.destroy(),Artbot.interests.destroy(),"undefined"==typeof localStorage.prior_visit&&(localStorage.prior_visit=!0)}),$(document).on("pagehide","div[data-role=page]",function(a){$(a.target).remove()}),$(document).on("pagecontainershow",function(){var a=Artbot.startup;"function"==typeof a.init&&a.init(),"function"==typeof a.finalize&&a.finalize(),"undefined"==typeof localStorage.prior_visit&&(localStorage.prior_visit=!0)});